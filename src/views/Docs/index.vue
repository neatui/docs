  ...
  <PageView>
    ...
    <div class="flex-block" ui-flex="row xy">
      <Sidebar class="n-sl fw-auto">
        <span class="o-mm fs-xs mt-sl upper">{{ words['docs.introduction'] || 'Introduction' }}</span>
        <RouterLink active-class="co-main" class="ux-hover r-sm" to="/docs/introduction">NeatUI</RouterLink>
        <span class="o-mm fs-xs mt-sl upper">{{ words['docs.guides'] || 'Guides' }}</span>
        ...
        <span class="o-mm fs-xs mt-sl upper">{{ words['docs.style'] || 'Style' }}</span>
        ...
        <span class="o-mm fs-xs mt-sl upper">{{ words['docs.version'] || 'Version' }}</span>
