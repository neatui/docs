<template>
  <DocView>
    <div>
      <h1>{{ words['components.input'] || 'Input' }}</h1>
      <p>通过鼠标或键盘输入字符</p>
    </div>
    <div>
      <h2>代码演示</h2>
      <ul ui-row="space mob-24 dpc-12">
        ...
        <li>
          <CodeView file="/docs/components/Input/Input.md">
            <h5>数字类型</h5>
            <div class="max-w-ls">
              <Input v-model="value2" type="number"> </Input>
            </div>
          </CodeView>
        </li>
        <li>
          <CodeView file="/docs/components/Input/Input-2.md">
            <h5>添加校验规则</h5>
            <div class="max-w-ls">
              <Input v-model="value3" :rules="rules3" :verify="true"> </Input>
            </div>
          </CodeView>
        </li>
        <li>
          <CodeView file="/docs/components/Input/Input-2.md">
            <h5>多值输入</h5>
            <div class="max-w-ls">
              <InputRange v-model="value4"> </InputRange>
            </div>
          </CodeView>
        </li>
      </ul>
...
<script setup lang="ts">
  ...
  import { Input, InputRange } from '@neatui/vue';
