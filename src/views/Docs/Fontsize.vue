    ...
    <div class="doc mb-ls-sub">
      <div class="mb-mm-sub">
        <div>
          <h3>全局字号</h3>
          <p>
            点击下面的按钮切换全局字号，本站选用的字号系统有5档，档位可扩展可选用不同档位的scss字号系统。如需前端记住字号状态，可以采用cookie方案。推荐命名用全站开源插件<a
              class="co-link"
              ui-hover=":underline"
              href="#/plugins/mc-cookie"
              >@fekit/cookie</a
            >
          </p>
          <button class="j_size" ui-btn="@a s :abs :border" size="xs">极小</button>
          <button class="j_size" ui-btn="@a s :abs :border" size="s">小号</button>
          <button class="j_size" ui-btn="@a s :abs :border" size="m">中号</button>
          <button class="j_size" ui-btn="@a s :abs :border" size="l">大号</button>
          <button class="j_size" ui-btn="@a s :abs :border" size="xl">超大</button>
        </div>
        <div>
          <h3>分级字号</h3>
          <p>分级字号是响应全局字号的</p>
          <table ui-table="@a grid">
            <tbody>
              ...
              <!-- <tr>
                  <td><code class="co-code">.fs-xxs</code></td>
                  <td><code class="co-code">0.7rem</code></td>
                  <td><span class="fs-xxs">文字等级: FS-XXS</span></td>
                </tr> -->
              <tr>
              ...
              <!-- <tr>
                  <td><code class="co-code">.fs-xxl</code></td>
                  <td><code class="co-code">4.6rem</code></td>
                  <td><span class="fs-xxl">文字等级: FS-XXL</span></td>
                </tr> -->
            </tbody>
          </table>
        </div>
