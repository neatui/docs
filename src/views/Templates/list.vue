<template>
  <div class="ny-ms">
    <div class="box">
      <h1 class="am-view">{{ words['templates.title'] || '案例' }}</h1>
      <p class="am-view">{{ words['templates.desc'] || '这里提供一些开发案例' }}</p>
    </div>
  </div>
  <div>
    <div class="box">
          ...
          <div>
            <div ui-card-body="">
              <div @click="fLink('http://qacms.fekit.cn/')">
                ...
                <p class="my-ss co-desc">{{ words['templates.1.desc'] || '基于 NeatUI 开发的表单设计系统（演示数据基于Mockjs）' }}</p>
              </div>
            </div>
          ...
          <div>
            <div ui-card-body="">
              <div @click="fLink('http://case.fekit.cn/aa/')">
                ...
                <p class="my-ss co-desc">{{ words['templates.2.desc'] || '基于 NeatUI 开发的管理系统模板（演示数据基于Mockjs）' }}</p>
              </div>
            </div>
            <div ui-card-foot="" ui-flex="row xm">
              <div ui-flex="row lm" class="fs-xs mr-sm-sub">
          ...
          <div>
            <div ui-card-body="">
              <div @click="fLink('http://vds.fekit.cn/#r=edit&item=1')">
                ...
                <p class="my-ss co-desc">{{ words['templates.3.desc'] || '基于 NeatUI 开发的页面生成系统（演示数据基于Mockjs）' }}</p>
              </div>
            </div>
            <div ui-card-foot="" ui-flex="row xm">
              <div ui-flex="row lm" class="fs-xs mr-sm-sub">
